...
| **Specs (the design record)** | [specs/](specs/)                                                                         | Numbered game-mechanic specs, including [specs/100-blender-asset-pipeline.md](specs/100-blender-asset-pipeline.md) and the parallel-safe [specs/102-commercial-garage-hero-glb.md](specs/102-commercial-garage-hero-glb.md). Active specs at `specs/NNN-*.md`; shipped ones move to [specs/built/](specs/built/). Index + format in [specs/README.md](specs/README.md). |
